...
import com.mifos.objects.templates.loans.Frequency;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by souljaboy764 on 8/1/17.
 */
public class CollectionMeetingCalendarPayload {
    ...
    private String startDate;// = new ArrayList<Integer>();
    ...
    private EntityType repeatsOnNthDayOfMonth;

    //@SerializedName("repeatsOnDay")
